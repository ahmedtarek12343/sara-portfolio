...
const Services = () => {
  ...
  return (
    <div className="relative services py-10 h-screen overflow-hidden bg-[#886641] flex justify-center items-center">
      ...
      <div className="main-services relative service-card w-[88vw] max-w-[380px] h-[65vh] max-h-[620px] bg-secondary rounded-3xl flex flex-col justify-start p-6 sm:p-8 md:p-10 shadow-2xl">
        <h3 className="text-primary text-2xl sm:text-3xl font-semibold mb-3">
          {services[0].title}
        </h3>
        ...
        <div className="card-1 absolute inset-0 w-full h-full bg-[#c9a876] rounded-3xl origin-bottom-left flex flex-col justify-start p-6 sm:p-8 md:p-10 shadow-2xl">
          <h3 className="text-secondary text-2xl sm:text-3xl font-semibold mb-3">
            {services[1].title}
          </h3>
        ...
        <div className="card-2 absolute inset-0 w-full h-full bg-primary rounded-3xl origin-bottom-right flex flex-col justify-start p-6 sm:p-8 md:p-10 shadow-2xl">
          <h3 className="text-secondary text-2xl sm:text-3xl font-semibold mb-3">
            {services[2].title}
          </h3>
          <p className="text-secondary/80 text-sm leading-relaxed">
